		...
		<div class="div-register-main ">
			<div class="container div-container">
				...
				<div class="row">
					...
					<div class="col-sm-10">
						<input v-model="form.recipients" id="input_recipients" type="text" placeholder=""
							class="form-control">
				...
				<div class="row">
					...
					<div class="col-sm-10">
						<input v-model="form.positions" id="input_positions" type="text" placeholder=""
							class="form-control">
				...
				<div class="row">
					...
					<div class="col-sm-10">
						<input v-model="form.phone" id="input_phone" type="text" placeholder=""
							class="form-control">
				...
				<div class="row">
					...
					<div class="col-sm-10">
						<input v-model="form.email" id="input_email" type="text" placeholder=""
							class="form-control">
...
import { URL_API, URL_GET_USER, URL_PUST_EDIT_USER, URL_PUST_REGISTER ,URL_GET_RECIPIENT_ALL,URL_PUT_RECIPIENT } from '../constants';
	...
	methods: {
		...
		Register() {
			if (this.validate_Register()) {
				...
				axios.put(`${URL_PUT_RECIPIENT}/${getid}`, {
