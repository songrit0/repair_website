        ...
        <div class="div-staus">
          <div class="col-12" style="justify-content: center; display: grid">
            <div class="item-staus I1">
              <img
                src="../img/clear_all_FILL0_wght400_GRAD0_opsz48.svg"
                width="40px"
              />
          ...
          <div class="col-12" style="justify-content: center; display: grid">
            <div class="item-staus I2">
              <img
                src="../img/quick_reference_FILL0_wght400_GRAD0_opsz48.svg"
                width="40px"
              />
          ...
          <div class="col-12" style="justify-content: center; display: grid">
            <div class="item-staus I3">
              <img
                src="../img/autorenew_FILL0_wght400_GRAD0_opsz48.svg"
                width="40px"
              />
          ...
          <div class="col-12" style="justify-content: center; display: grid">
            <div class="item-staus I4">
              <img
                src="../img/done_FILL0_wght400_GRAD0_opsz48.svg"
                width="40px"
              />
...
export default {
  ...
  methods: {
    ...
    GETall_lengthdata() {
      ...
      axios
        .get(
          `${URL_GET_ALL_REQ}/?staus=กำลังดำเนินการ&user_id=${localStorage.users_id}`
        )
        .then((response) => {
      ...
      axios
        .get(
          `${URL_GET_ALL_REQ}/?staus=ซ่อมเสร็จ&user_id=${localStorage.users_id}`
        )
        .then((response) => {
