    ...
    <div class="card" :style="Register_on ? 'top : 800px' : 'top : 0px '">
      ...
      <div class="input-div">
        <div class="input-group">
          <b class="a-User" id="a-User">User</b>
          <input
            id="input_user_login"
        ...
        <div class="input-group">
          <b class="a-User" id="a-password">password</b>
          <input
    ...
    validate_login() {
      ...
      if (!this.formlogin.user) {
        ...
        document.getElementById("input_user_login").style.border =
          "3px solid red";
        document.getElementById("input_user_login").style.borderRadius =
          "0px 6px 6px 0";
        ...
        axios
          ...
          .then(function (response) {
            ...
            if (
              ...
              ).style.borderRadius = "0px 6px 6px 0";
              document.getElementById("input_password_login_err").innerHTML =
                "USER Login False";
              Swal.fire({
                position: "center",
...
.card {
  ...
  border-radius: 10px;
  background: #e9e9e9;
  box-shadow: -29px 29px 58px #8f8f8f, 29px -29px 58px #ffffff;
