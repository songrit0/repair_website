<template>
  <div class="div-home">
    <div class="div-home-pages">
      <h1>ระบบแจ้งซ่อม</h1>
      <div class="div-home-row">
        <div
          class="item p-3 back-img-register background-img-Repair"
          @click="$router.push(`/RepairNew`)"
        >
          <h4>แจ้งซ่อม</h4>
          Repair
        </div>
        <div
          v-if="$store.state.newUSER.user_status === 'admin'"
          class="item p-3 back-img-register background-img-Notification"
          @click="$router.push(`/Receive_Repair`)"
        >
          <h4>รับ แจ้งซ่อม2</h4>
          Repair Notification
        </div>
      ...
      <div
        v-if="$store.state.newUSER.user_status === 'admin'"
        class="div-home-row-User"
      >
        <div
          class="item-User p-3 back-img-register background-img-register"
        ...
        <div
          class="item-User p-3 back-img-register background-img-user"
